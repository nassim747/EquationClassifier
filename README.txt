...
- **`assignment_2.ipynb`**: The main Jupyter Notebook containing the implementation, training pipeline, and evaluation code.
- **`x_test.npy` & `y_test.npy`**: Example datasets for testing the model.
- **`predicted_labels.csv`**: Submission file for Kaggle competition.
...
2. Install dependencies:
   ...
   ```
3. Run the notebook:
   Open `assignment_2.ipynb` in Jupyter Notebook or JupyterLab and execute the cells sequentially.
